...
if ( ! class_exists('Giotto_Meta_Box')) :
    class Giotto_Meta_Box
    {
        ...
        {
            $this->meta_box_id   = $args['meta_box_id'] ?: 'giotto_meta_box';
        ...
        public function meta_fields_callback()
        {
            ...
            echo '<input type="hidden" name="giotto_cmb_nonce" id="giotto_cmb_nonce" value="' .
...
if ( ! function_exists('giotto_meta_box')) {
    ...
    {
        return new Giotto_Meta_Box($args);
    }
}
...
$args        = array(
    ...
    'fields'        => array(
        array(
            ...
            'default' => get_theme_mod('giotto_sidebar_layout', 'sidebar'),
            'options' => array(
