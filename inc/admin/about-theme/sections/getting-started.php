...
<div class="content-info-about">
	...
	<div class="intro-head">
		<h1 class="giottopress-welcome-title"><?php _e('Welcome to GiottoPress!', 'giottopress'); ?> <?php if( !empty($giottopress_lite['Version']) ): ?> <sup id="giottopress-theme-version"><?php echo esc_attr( $giottopress_lite['Version'] ); ?> </sup><?php endif; ?></h1>
