        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'giottopress.pot',              // Name of the POT file.
                    type: 'wp-theme',                      // Type of project (wp-plugin or wp-theme).
                    processPot: function (pot, options) {
                        pot.headers['report-msgid-bugs-to'] = 'https://giottopress.io/support';
                        pot.headers['plural-forms'] = 'nplurals=2; plural=n != 1;';
                        pot.headers['last-translator'] = 'Enrique Chavez <me@enriquechavez.co>\n';
                        pot.headers['language-team'] = 'Enrique Chavez <me@enriquechavez.co>\n';
